    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            <h4 className<dyad-problem-report summary="1 problems">
<problem file="src/components/webhook/WebhookUniversalConfig.tsx" line="59" column="30" code="2304">Cannot find name 'setLists'.</problem>
</dyad-problem-report><dyad-write path="src/components/webhook/WebhookUniversalConfig.tsx" description="Fixing the setLists function call">
"use client";
