        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              Se a fonte tiver chave de API, a URL exigirá o parâmetro api_key; se estiver vazia, não é exigido.
            </p>
          </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              A URL já inclui source (usuário), source_id (fonte) e list_id (lista). Se a fonte tiver chave, inclui api_key.
            </p>
          </div>
        </CardContent>
      </Card>
