...
const formSchema = z.object({
  ...
  phone_number: z.string().regex(/^\d{10,13}$/, "Informe DDD+Número (ex: 11987654321)."),
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                Informe apenas DDD + Número. O DDI do país selecionado acima será aplicado automaticamente.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
